...
**本书主要讲解游戏服务器如何构建，可以结合作者的《Unity3D网络实战2》一起来看，此书的受众应该为游戏服务开发人员或者是高级游戏开发者；本书的讲解了Skynet的使用、仿写Skynet以及游戏服务器常见的问题，例如同步算法和热更新；Skynet虽然是一套老的服务器框架，但是能沿用至今也是有其优点的；例如：高性能、易用、可扩展。**
